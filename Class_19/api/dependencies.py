...
# Shipment
def get_shipment_server(session: SessionDep, tasks: BackgroundTasks):
...
ShipmentServiceDep=Annotated[ShipmentService,Depends(get_shipment_server)]

# Seller service dep annotation
SellerServiceDep=Annotated[SellerService,Depends(get_seller_server)]
