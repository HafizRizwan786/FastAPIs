...
from Class_28.database.models import ShipmentEvent, ShipmentStatus, Tag, TagName
from datetime import datetime
from uuid import UUID
from Class_28.database.models import Seller
...
class ShipmentCreate(BaseShipment):
    """ Shipment detail to create a new shipment"""
