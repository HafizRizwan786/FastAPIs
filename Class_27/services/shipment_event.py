...
from Class_27.database.models import ShipmentEvent,Shipment,ShipmentStatus
from random import randint
from Class_27.database.redis import add_shipment_verification_code
from Class_27.utils import generate_url_safe_token
from Class_27.config import app_settings
from Class_27.worker.tasks import send_sms,send_email_with_template
        ...
        match status:
            ...
            case ShipmentStatus.out_for_delivery:
                ...
                if shipment.client_contact_number:
                    send_sms.delay(
                        to=shipment.client_contact_number,
                        body=f"Your order is arriving soon! Share the {code} code with your delivery executive to recieve your packet.",
