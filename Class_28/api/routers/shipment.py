from Class_28.utils import TEMPLATE_DIR
from fastapi import APIRouter,status,Request,Form
from Class_28.core.exceptions import NothingToUpdate
# from fastapi.responses import HTMLResponse
from Class_28.api.schemas.shipment import ShipmentRead,ShipmentUpdate,ShipmentCreate
from Class_28.api.dependencies import ShipmentServiceDep,SellerDep,DeliveryPartnerDep,SessionDep
from Class_28.database.models import Shipment, TagName
...
@router.post(
    ...
    responses={
        ...
        status.HTTP_406_NOT_ACCEPTABLE : {'description' : "Delivery partner is not availible"}
    }
)
