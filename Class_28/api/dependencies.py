...
from Class_28.services.shipment import ShipmentService
from Class_28.services.delivery_partner import DeliveryPartnerService
from Class_28.services.seller import SellerService

from typing import Annotated
from uuid import UUID

from fastapi import Depends, status
from Class_28.core.exceptions import InvalidToken, ClientNotAuthorized
from sqlalchemy.ext.asyncio import AsyncSession

from Class_28.core.security import oauth2_scheme_seller,oauth2_scheme_partner
from Class_28.utils import decode_access_token

from Class_28.database.models import Seller,DeliveryPartner
from Class_28.database.redis import is_jti_blacklisted
from Class_28.database.session import get_session
