...
from Class_28.core.exceptions import DeliveryPartnerNotAvailable
from sqlmodel import select, any_

from Class_28.api.schemas.delivery_partner import DeliveryPartnerCreate
from Class_28.database.models import DeliveryPartner, Shipment

from Class_28.services.user import UserService
