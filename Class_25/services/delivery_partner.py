...
from Class_25.api.schemas.delivery_partner import DeliveryPartnerCreate
from Class_25.database.models import DeliveryPartner, Shipment

from Class_25.services.user import UserService
