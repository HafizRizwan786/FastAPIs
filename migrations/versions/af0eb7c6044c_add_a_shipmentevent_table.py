"""add a ShipmentEvent table

Revision ID: af0eb7c6044c
Revises: 9f479e7003e4
Create Date: 2026-07-02 08:10:08.685145
...
revision: str = 'af0eb7c6044c'
down_revision: Union[str, Sequence[str], None] = '9f479e7003e4'
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('shipment', sa.Column('status', postgresql.ENUM('placed', 'in_transit', 'delivered', 'out_for_delivery', name='shipmentstatus'), autoincrement=False, nullable=False))
