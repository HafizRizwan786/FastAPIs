...
from Class_24.api.schemas.delivery_partner import DeliveryPartnerCreate
from Class_24.database.models import DeliveryPartner, Shipment

from Class_24.services.user import UserService
