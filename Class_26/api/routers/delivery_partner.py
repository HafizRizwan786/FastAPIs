...
from Class_26.api.schemas.delivery_partner import DeliveryPartnerCreate,DeliveryPartnerRead,DeliveryPartnerUpdate
from Class_26.api.dependencies import DeliveryPartnerDep,get_partner_access_token,DeliveryPartnerServiceDep
